...
def seed_recipes():
    cuisine1 = Recipe(
        ...
        details="Authentic Mexican street tacos filled with marinated pork, pineapple, and cilantro.",
        category_id=1,
        user_id = 1,
    ...
    cuisine3 = Recipe(
        ...
        details="Tortillas filled with shredded chicken, topped with green salsa, cheese, and sour cream.",
        category_id=1,
        user_id = 3,
    ...
    cuisine9 = Recipe(
        name="Ceviche",
        details="Fresh seafood marinated in lime juice, mixed with tomatoes, onions, cilantro, and served with tortilla chips.",
        category_id=1,
        user_id = 1,
    ...
    cuisine16 = Recipe(
        name="Mapo Tofu",
        details="Mapo Tofu is a spicy Sichuan dish that combines silky tofu, ground pork, and a flavorful sauce. The dish is known for its numbing spiciness and complex flavors. To make Mapo Tofu, you start by frying ground pork with aromatic ingredients like ginger, garlic, and fermented black beans. Then, you add a combination of chili bean paste, doubanjiang, and Sichuan peppercorns to create a spicy and flavorful sauce. Cubes of soft tofu are gently added to the sauce, allowing them to soak up all the delicious flavors. Serve Mapo Tofu with steamed rice and garnish with chopped green onions for an authentic and satisfying Chinese meal.",
        category_id=2,
        user_id=1,
    ...
    cuisine41 = Recipe(
        name="Cheeseburger",
        details="The cheeseburger is a variation of the classic hamburger, featuring a beef patty topped with cheese. It is a popular American fast-food item and can also be found in diners and restaurants. The cheeseburger follows the same preparation method as a hamburger, with the addition of a slice of cheese, typically American or cheddar, placed on top of the cooked patty. The cheese melts slightly from the residual heat of the patty, adding a creamy and savory element to the burger. Cheeseburgers are often served with condiments, vegetables, and a side of fries or a salad.",
        category_id=5,
        user_id=2,
    ...
    cuisine47 = Recipe(
        ...
        details="Quiche Lorraine is a classic French savory tart made with a buttery pastry crust filled with a mixture of eggs, cream, cheese, and bacon. The filling is seasoned with salt, pepper, and sometimes nutmeg. The quiche is baked until the filling is set and the crust is golden and crisp. Quiche Lorraine can be enjoyed warm or at room temperature and is often served as a brunch or lunch dish. It pairs well with a side salad and is a delicious and versatile recipe that can be customized with different ingredients.",
        category_id=6,
        user_id=4,
    ...
    cuisine48 = Recipe(
        name="Crêpes",
        details="Crêpes are thin and delicate French pancakes made from a simple batter of flour, eggs, milk, and butter. They are cooked in a flat pan or crêpe pan until golden and lacy. Crêpes can be enjoyed with both sweet and savory fillings. Popular sweet fillings include Nutella, fresh fruits, whipped cream, or maple syrup. Savory options may include cheese, ham, mushrooms, or spinach. Crêpes are a versatile and delicious treat, perfect for breakfast, dessert, or a light meal.",
        category_id=6,
        user_id=1,
